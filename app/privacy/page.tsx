        ...
        <article className="py-14">
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 sm:p-10 prose prose-gray max-w-none">
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">3. Database and Infrastructure — Supabase</h2>
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">4. Payments — Stripe</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">5. User Content and Messages</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">6. Cookies and Tracking</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">7. Sharing Your Information</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">9. Data Retention</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <h2 className="text-xl font-bold text-gray-900 mt-8 mb-3">11. Security</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
